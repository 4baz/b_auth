...
if(isset($_POST['submit_email'])) {
    if(functions::captcha_check('gfsgfsd', $_POST['g-recaptcha-response'])) {
        $reset_result = api\main\send_reset_email_user($c_con, $_POST['username']);
...
if(isset($_POST['reset_pass'])) {
    $reset_result = api\main\reset_password_with_code_user($c_con, $code, $_POST['new_password']);
