                                    ...
                                    <div class="dt-card__body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="" onchange="myFunction(event)">
                                             <option disabled selected>Choose Token Type</option>
                                             <option value="30">30 days</option>
                                            <option value="9999">LifeTime</option>
                                            <option value="custom - changeme">Custom</option>
                                            </select>
...
function myFunction(e) {
    document.getElementById("token_days").value = e.target.value
    Readonly(document.getElementById("token_days").value)
}

function Readonly(e) {

    if(e === "custom"){
        document.getElementById("token_days").Readonly = false;
    }else{
        document.getElementById("token_days").Readonly = true;
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="" onchange="changefucnc(event)">
                                             <option disabled selected>Choose Token Level</option>
...
function changefucnc(e) {
    document.getElementById("token_level").value = e.target.value
   // Readosnly(document.getElementById("token_level").value)
}

function Readosnly(e) {

  /*  if(e === "custom"){
        document.getElementById("token_level").Readonly = false;
    }else{
        document.getElementById("token_level").Readonly = true;
