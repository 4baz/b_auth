...
$app_to_manage = 'staffthing';


if(isset($_POST['DL_TOKENS'])){

    $dl_resp = api\admin\fetch_all_tokens($c_con, $app_to_manage);


    foreach($dl_resp as $t_value){

        echo $t_value['c_token'];
        echo $t_value['c_used'] ? 'true' : 'false';
                ...
                <div class="dt-sidebar__container">
                    ...
                    <ul class="dt-side-nav">
                        ...
                        <li class="dt-side-nav__item">
                            <a href="staff_users.php" class="dt-side-nav__link">
                                <i class="icon icon-dashboard icon-fw icon-lg"></i>
                                <span class="dt-side-nav__text">manage users</span>
                            </a>
                        </li>
                        ...
                        <div class="row">
                            <div class="col-xl-10 col-sm-10 col-1">
                                <div class="dt-card">
                                    ...
                                    <div class="dt-card__body">
                                        <button type="" name="DL_TOKENS" class="btn btn-primary text-uppercase">print tokens to web page </button>
                                    </div>
                                </div>
                            </div>
                        </div>
